...
public class Blob {
    ...
    public INDArray generateInputVector(List<Food> foods, List<Blob> blobs) {
        ...
        for (Food food : foods) {
            ...
            // Food adjacent to the blob
            if (distance(position, food.position) <= 1) {
